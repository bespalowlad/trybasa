<template lang="pug">
    div
        block-header
        #menu-div.content
            //- iframe(id="jane-menu" frameborder="0" height="100%" :src="'https://www.iheartjane.com/embed/stores/173/'+$route.params.slug+'?&amp;og_ref='+ref+''" scrolling="no" style="width: 1px; min-width: 100%;")
    ...
    export default {
        ...
        methods: {
          iheartjane() {
            ...
            iframe.src = "https://www.iheartjane.com/embed/stores/173/menu/?" + query.join("&");
